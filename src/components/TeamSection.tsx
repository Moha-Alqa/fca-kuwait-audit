        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
          ...
          <Card className="border-none shadow-lg overflow-hidden">
            <CardContent className="p-0">
              <div className="aspect-[3/4] bg-gray-200 relative">
                <img
                  src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80"
                  alt="Mrs. Laila Alqahtani"
          ...
          <Card className="border-none shadow-lg overflow-hidden">
            <CardContent className="p-0">
              <div className="aspect-[3/4] bg-gray-200 relative">
                <img
                  src="https://images.unsplash.com/photo-1556157382-97eda2f9e861?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80"
                  alt="Ahmed Yahia"
                  className="w-full h-full object-cover"
                />
              </div>
