    ...
    <section id="about" className="py-20 bg-white">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="mb-12 text-center">
          <h2 className="text-3xl font-bold text-[#0A5F6E] sm:text-4xl mb-4">
            {t("about.title")}
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            <h3 className="text-2xl font-semibold text-[#0A5F6E] mb-4">
          ...
          <div className="relative h-80 rounded-lg overflow-hidden shadow-xl">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#0A5F6E]/60 to-transparent"></div>
          </div>
        </div>

        <div className="mt-20">
          <h3 className="text-2xl font-semibold text-[#0A5F6E] mb-6 text-center">
            {t("about.whyChoose")}
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border-none shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="pt-6">
                <div className="w-12 h-12 bg-[#E6F3F5] text-[#0A5F6E] flex items-center justify-center rounded-full mb-5 mx-auto">
            ...
            <Card className="border-none shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="pt-6">
                <div className="w-12 h-12 bg-[#F9F3E6] text-[#D4AF37] flex items-center justify-center rounded-full mb-5 mx-auto">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
